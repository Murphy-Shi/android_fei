 ...
 * @Author: murphy
 * @CreateDate: 2021/9/24 10:58 上午
 * @UpdateUser: 更新者
 * @UpdateDate: 2021/9/24 10:58 上午
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class FloatBallView extends RelativeLayout {
    ...
    private void initImg(){
        if(mImageView == null) {
            ...
            mImageView.setLayoutParams(new FrameLayout.LayoutParams(mWidth, mHeight));
            mImageView.setScaleType(ImageView.ScaleType.FIT_XY);
        }
        addView(mImageView);
    }

    public void setImageResource(int floatImgId){
        mImageView.setImageResource(floatImgId);
    }
    ...
    private void startAnim() {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                mWindowManager.updateViewLayout(FloatBallView.this, floatLayoutParams);
            }
        });
        valueAnimator.start();
    }
